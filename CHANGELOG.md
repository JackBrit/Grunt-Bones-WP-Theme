...
/* 1.8 update by Vincent Roussy */
- New custom grid system from Boostrap 
- Custom breakpoints editable in _variables.scss
- Fancy typography ligatures fix
- TGM require plugins option
- Redux Framework implementaion
- Meta box plugin option with demo content to activate
- Main menu seo metas 
